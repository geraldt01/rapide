    ...
    if (searchInput.length) {
      ...
      var searchDataOrig = $.ajax({
        ...
        async: false
         ...
         var searchDataget = $.ajax({
            url: '/app/search/car',//? Use your own search api instead
              dataType: 'json',
              async: false
            }).responseJSON;

      var searchData = searchDataget[0];

        

    console.log(searchDataOrig);
        ...
        searchInput
          .typeahead(
            ...
            // Pages
            {
              ...
              templates: {
                header: '<h6 class="suggestions-header text-primary mb-0 mx-3 mt-3 pb-2">Cars</h6>',
                ...
                notFound:
                  ...
                  '<h6 class="suggestions-header text-primary mb-2">Cars</h6>' +
