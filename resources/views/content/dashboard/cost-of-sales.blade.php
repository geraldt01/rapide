...
@section('page-script')
<script src="{{asset('assets/js/app-ecommerce-cost-of-sales.js')}}"></script>
...
@section('content')
<h4 class="py-3 mb-4">
  <span class="text-muted fw-light"> Cost Of Sales
</h4>
...
<div class="card">
  ...
  <div class="card-datatable table-responsive">
    <!-- <table class="datatables-products-dashboard table">
    ...
    <table class="table">
      <thead>
        <tr>
          ...
          <th>UNIT COST</th>
          <th>TOTAL COST</th>
          <th>UNIT SELLING<br> PRICE WITH<br> LABOR </th>
          <th>TOTAL SELL<br> PRICE</th>
          <th style="width: 5%">TOTAL INV<br> AMOUNT<br> PACKAGE</th>
          <th style="width: 5%"></th>
        </tr>
      </thead>
      <tbody  id="tblcosHtml">
