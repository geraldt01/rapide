    ...
    <div class="d-flex justify-content-between flex-column mb-3 mb-md-0">
      <ul class="nav nav-align-left nav-pills flex-column">
        <li class="nav-item mb-1">
          <a class="nav-link " href="{{url('/app/dropdown-option')}}">
            <i class="mdi mdi-storefront-outline me-2"></i>
            <span class="align-middle">Special Note</span>
          </a>
        </li>
        <li class="nav-item mb-1">
        ...
        <li class="nav-item mb-1">
          <a class="nav-link active" href="{{url('/app/ecommerce/settings/car-vehicle-type')}}">
            <i class="mdi mdi-credit-car-outline me-2"></i>
        ...
        <div class="card mb-4">
          <div class="card-header d-flex justify-content-between align-items-start">
            <div class="card-title m-0">
              <h5 class="m-0">Car Vehicle Types</h5>
          ...
          <div class="card-body">
              ...
              <div class="table-responsive text-nowrap border rounded">
                <table class="table">
                  <thead class="table-light">
                    <tr>
                      <th>#</th>
                      <th>Car Vehicle Type</th>
                      <th class="text-end">Actions</th>
                    </tr>
                  </thead>
                  <tbody id="tbl-vehicle-type-body">
                @foreach($VehicleTypeData  as $k => $vehicletype)
                    <tr>
                      <td>{{$k +1}}</td>
                      ...
                      <td class="text-end">
                        <div class="dropdown pe-3">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#addNewVehicleTypeOption" onclick="editVehicleType({{$vehicletype->id}})"><i class="mdi mdi-pencil-outline me-1"></i> Edit</a>
                            <a class="dropdown-item" onclick="promptDeleteVehicleType({{$vehicletype->id}})"><i class="mdi mdi-delete-outline me-1" ></i> Delete</a>
                          </div>
                        </div>
                      </td>
                    </tr>
            ...
            <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#addNewVehicleTypeOption" onclick="createVehicleType()">Add Vehicle Type</button>
          </div>
        </div>
      </div>
    </div>
...
@include('_partials/_modals/modal-add-new-vehicle-type-option')
@endsection
