...
<!-- Edit User Modal -->
<div class="modal fade" id="changeInvoiceNumber" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-simple modal-edit-user">
    <div class="modal-content p-3 p-md-5">
      <div class="modal-body py-3 py-md-0">
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        <div class="text-center mb-4">
          <h3 class="mb-2">Change Invoice Number <span id="car-plate-number" class="text-primary mb-0"></span></h3>
          <!-- <p class="pt-1">Updating user details will receive a privacy audit.</p> -->
        </div>
        <form id="form-change-invoice-number" class="row g-4" onsubmit="return false">
         <input type="hidden" name="jo_id" id="jo-id" value="" />
          <div class="col-12 col-md-12">
            <div class="form-floating form-floating-outline">
              <input type="number" id="modalInvoiceNumber" name="modalInvoiceNumber" class="form-control" />
              <label for="modalInvoiceNumber" calss="active">Invoice Number</label>
            </div>
          </div>
         
          <div class="col-12 text-center">
            <button type="submit" class="btn btn-primary me-sm-3 me-1 btn-submit" onclick="editInvoiceNumber()">Submit</button>
            <button type="reset" class="btn btn-outline-secondary" data-bs-dismiss="modal" aria-label="Close">Cancel</button>
          </div>
        </form>
      </div>
