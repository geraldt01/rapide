...
use App\Http\Controllers\apps\InventoryDashboard;
...
use App\Http\Controllers\pages\Gcash;
...
Route::post('/app/job-order/deduct-inventory-stock/{job_order_id}', [InvoiceEdit::class, 'deductInventoryStock'])->middleware('auth');
...
Route::get('/app/dropdown-option', [EcommerceSettingsDetails::class, 'index'])->name('app-settings-details')->middleware('auth');
Route::get('/app/special-note/get/{note_id}', [EcommerceSettingsDetails::class, 'getSpecialNote'])->name('app-settings-details')->middleware('auth');
Route::get('/app/special-note/update/{note_id}', [EcommerceSettingsDetails::class, 'updateSpecialNote'])->name('app-settings-details')->middleware('auth');
Route::get('/app/special-note/save/', [EcommerceSettingsDetails::class, 'saveSpecialNote'])->name('app-settings-details')->middleware('auth');
Route::get('/app/special-note/show/', [EcommerceSettingsDetails::class, 'showSpecialNote'])->name('app-settings-details')->middleware('auth');
Route::get('/app/special-note/delete/{note_id}', [EcommerceSettingsDetails::class, 'deleteSpecialNote'])->name('app-settings-details')->middleware('auth');

Route::get('/app/car-manufacturer/get/{manufacturer_id}', [EcommerceSettingsCarManufacturer::class, 'getManufacturer'])->name('app-settings-details')->middleware('auth');
Route::get('/app/car-manufacturer/update/{manufacturer_id}', [EcommerceSettingsCarManufacturer::class, 'updateManufacturer'])->name('app-settings-details')->middleware('auth');
Route::get('/app/car-manufacturer/save/', [EcommerceSettingsCarManufacturer::class, 'saveManufacturer'])->name('app-settings-details')->middleware('auth');
Route::get('/app/car-manufacturer/show/', [EcommerceSettingsCarManufacturer::class, 'showManufacturer'])->name('app-settings-details')->middleware('auth');
Route::get('/app/car-manufacturer/delete/{manufacturer_id}', [EcommerceSettingsCarManufacturer::class, 'deleteManufacturer'])->name('app-settings-details')->middleware('auth');

Route::get('/app/car-vehicle-type/get/{vehicle_type_id}', [EcommerceSettingsCarVehicleType::class, 'getVehicleType'])->name('app-settings-details')->middleware('auth');
Route::get('/app/car-vehicle-type/update/{vehicle_type_id}', [EcommerceSettingsCarVehicleType::class, 'updateVehicleType'])->name('app-settings-details')->middleware('auth');
Route::get('/app/car-vehicle-type/save/', [EcommerceSettingsCarVehicleType::class, 'saveVehicleType'])->name('app-settings-details')->middleware('auth');
...
Route::get('/json/inventory-dashboard', [InventoryDashboard::class, 'jsonInventoryList'])->middleware('auth');
Route::get('/app/inventory/view-details/{item_id}', [InventoryDashboard::class, 'viewInventoryDetails'])->middleware('auth');
Route::get('/app/inventory/save/{item_id}', [InventoryDashboard::class, 'saveInventory'])->middleware('auth');
Route::post('/app/inventory/import', [InventoryDashboard::class, 'importInventory'])->middleware('auth');
...
Route::get('/payment-confirm', [Gcash::class, 'index'])->name('pages-misc-under-maintenance');
...
// laravel example
Route::get('/laravel/user-management', [UserManagement::class, 'UserManagement'])->name('laravel-example-user-management')->middleware('auth');
